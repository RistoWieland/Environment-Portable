...
def display_writing(data_list):
    ...
    draw.text((84, 11), "T2:" + str(data_list[3]) + "°C", font=font, fill=255)
    draw.text((42, 22), "T3:" + str(data_list[4]) + "°C", font=font, fill=255)
    draw.text((84, 22), "T4:" + str(data_list[6]) + "°C", font=font, fill=255)
