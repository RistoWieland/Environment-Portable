...
def display_writing(data_list):
    ...
    draw.text((86, 11), "T2:" + str(data_list[3]) + "°C", font=font, fill=255)
    draw.text((43, 22), "T3:" + str(data_list[4]) + "°C", font=font, fill=255)
    draw.text((86, 22), "T4:" + str(data_list[6]) + "°C", font=font, fill=255)
